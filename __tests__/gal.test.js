...
describe('Traveler', () => {
  ...
  describe ('Traveler#surpassed', () => {
    ...
    test("should update 'surpassed' method based on Mercury", () => {
      const astronaut = new Traveler(83, "Mercury"); 
      expect(astronaut.planet).toEqual("Mercury");
      expect(astronaut.surpassed()).toEqual("You've outlived your expected life span by 21.67 years.");
    });

    test("should update 'surpassed' method based on Venus", () => {
      const astronaut = new Traveler(83, "Venus"); 
      expect(astronaut.planet).toEqual("Venus");
      expect(astronaut.surpassed()).toEqual("You've outlived your expected life span by 8.39 years.");
    });

    test("should update 'surpassed' method based on Mars", () => {
      const astronaut = new Traveler(83, "Mars"); 
      expect(astronaut.planet).toEqual("Mars");
      expect(astronaut.surpassed()).toEqual("You've outlived your expected life span by 2.77 years.");
    });

    test("should update 'surpassed' method based on Jupiter", () => {
      const astronaut = new Traveler(83, "Jupiter"); 
      expect(astronaut.planet).toEqual("Jupiter");
